...
SSI is an evolving ecosystem which, although still in it's infancy, already has established a solid foundation, which in-turn will seed a system-wide disruption of what we know as the internet today. 
...
All these 3 innovations are big on their own, and fairly independent of one another, but it is when combined, they truly realize their full potential, and become a whole that is much more than the sum of it's parts. This whole is referred to as SSI or self-sovereign identity.
